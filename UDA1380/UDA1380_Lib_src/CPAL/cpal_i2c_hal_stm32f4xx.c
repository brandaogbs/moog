...
{  
  ...
  uint32_t temp = CPAL_I2C_EV_IRQHandler(&I2C1_DevStructure);
...
uint32_t CPAL_I2C1_DMA_TX_IRQHandler(void)
{
  ...
  uint32_t temp = CPAL_I2C_DMA_TX_IRQHandler(&I2C1_DevStructure);
...
uint32_t CPAL_I2C1_DMA_RX_IRQHandler(void)
{
	...
	uint32_t temp = CPAL_I2C_DMA_RX_IRQHandler(&I2C1_DevStructure);
