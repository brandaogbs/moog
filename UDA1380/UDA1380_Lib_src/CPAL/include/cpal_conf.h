...
#define _CPAL_TIMEOUT_DEINIT()	if (CPAL_timeout_init)                      \
									vTaskSuspend(CPAL_timeout_task_handle);
                                       /*<! Disable the systick timer */


/*#define CPAL_I2C_TIMEOUT_Manager       CPAL_I2C_TIMEOUT_Manager */ /*<! This callback is used to handle Timeout error.
...
#ifdef CPAL_DEBUG
#define CPAL_LOG(Str)                   SH_SendString(Str)
